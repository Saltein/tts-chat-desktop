...
// Селекторы
export const selectTwitchConnectionData = (state) =>
    state.connection.twitch.chatChannelName;
export const selectTwitchConnectionStatus = (state) =>
    state.connection.twitch.connectionStatus;
...
export const selectVkConnectionData = (state) =>
    state.connection.vk.vkConnectionData;
export const selectVkConnectionStatus = (state) =>
